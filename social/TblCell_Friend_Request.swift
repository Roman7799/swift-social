//
//  TblCell_Request_User.swift
//  social
//
//  Created by Denis Vesnin on 8/22/19.
//  Copyright © 2019 Geolance. All rights reserved.
//

import UIKit

protocol Friend_Request_Delegate: class {
    func Exec_Friend_Request(with action: String, status: Int, from cell: UITableViewCell)
}

class TblCell_Friend_Request: UITableViewCell {
    ...
    var delegate: Friend_Request_Delegate?
    ...
    @IBAction func confirmButton_clicked(_ sender: Any) {
        ...
        Action_Message.text = "Request accepted"
